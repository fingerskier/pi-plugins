...
```
dude_upsert_record { "kind": "spec", "title": "API: <description>", "body": "<details>" }
dude_upsert_record { "kind": "arch", "title": "ARCH: <description>", "body": "<details>" }
```
...
| Tool | Purpose |
|------|---------|
| `dude_list_records` | Fetch specs/arch records by kind and status |
| `dude_upsert_record` | Update or create records |
| `dude_search` | Find related specs if needed |

## Related Skills

- **dude_review-issues**: Review and groom issues
- **dude_specifications**: CRUD reference for spec operations
